<?php
/*
 * User Role Editor Mtaandao plugin options page
 *
                ...
                <tr>
                    <td>
                        ...
                        <?php echo ($show_admin_role == 1) ? 'checked="checked"' : ''; ?>
                               <?php echo defined('URE_SHOW_ADMIN_ROLE') ? 'disabled="disabled" title="Predefined by \'URE_SHOW_ADMIN_ROLE\' constant at db.php"' : ''; ?> />
...
?>
    ...
    <?php mn_nonce_field('user-role-editor'); ?>   
