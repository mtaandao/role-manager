...
class URE_Posts_Edit_Access_Role {
    ...
    public function add_js() {
        mn_register_script('ure-posts-edit-access', plugins_url('/pro/js/posts-edit-access.js', URE_PLUGIN_FULL_PATH));
        mn_enqueue_script ('ure-posts-edit-access');
        mn_localize_script('ure-posts-edit-access', 'ure_data_posts_edit_access',
                array(
