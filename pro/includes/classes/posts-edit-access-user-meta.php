...
class URE_Posts_Edit_Access_User_Meta {
    ...
    public function __construct() {
        ...
        $this->umk_restriction_type = $mndb->prefix .'ure_posts_restriction_type';
        $this->umk_own_data_only = $mndb->prefix .'ure_own_data_only';
        $this->umk_posts_list = $mndb->prefix .'ure_posts_list';
        $this->umk_post_types = $mndb->prefix .'ure_post_types';        
        $this->umk_post_authors_list = $mndb->prefix .'ure_authors_list'; 
        $this->umk_post_categories_list = $mndb->prefix .'ure_categories_list';
