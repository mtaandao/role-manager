 ...
 * Class URE_Admin_Menu_View - support stuff for MN admin dashboard menu show in User Role Editor admin menu access add-on
...
<?php
    ...
    public static function add_js() {
        ...
        mn_register_script('ure-admin-menu-access', plugins_url( '/pro/js/ure-pro-admin-menu-access.js', URE_PLUGIN_FULL_PATH));
        mn_enqueue_script ('ure-admin-menu-access');
        mn_localize_script('ure-admin-menu-access', 'ure_data_admin_menu_access', 
                array(
...
<form name="ure_admin_menu_access_form" id="ure_admin_menu_access_form" method="POST"
      action="<?php echo URE_ADMIN_URL . ($network_admin ? 'network/':'') . URE_PARENT .'?page=users-'.URE_PLUGIN_FILE;?>" >
