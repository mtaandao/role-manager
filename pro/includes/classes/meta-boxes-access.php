...
<?php
    ...
    public function add_js() {
        mn_register_script( 'ure-meta_boxes-access', plugins_url( '/pro/js/meta-boxes-access.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-meta_boxes-access' );
        mn_localize_script( 'ure-meta_boxes-access', 'ure_data_meta_boxes_access',
                array(
