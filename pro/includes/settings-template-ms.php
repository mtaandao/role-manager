<?php
/*
 * User Role Editor Pro Mtaandao plugin options page
 *
...
?>
      <tr>
        <td>
            <input type="checkbox" name="manage_themes_access" id="manage_themes_access" value="1" 
            <?php echo ($manage_themes_access==1) ? 'checked="checked"' : ''; ?>            
