<?php
/*
 * User Role Editor Pro Mtaandao plugin - main class
    ...
    public function admin_css_action() {
        ...
        if (stripos($_SERVER['REQUEST_URI'], 'settings-user-role-editor')!==false) {
            ...
            if ($use_jquery_cdn_for_ui_css) {
                mn_enqueue_style('ure-jquery-ui-tabs', '//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css', array(), false, 'screen');
            } else {
...
//content view restrictions
    ...
    public function add_js() {
        ...
        mn_register_script( 'ure-js-pro', plugins_url( '/pro/js/ure-js-pro.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-js-pro' );
        ...
        mn_localize_script( 'ure-js-pro', 'ure_data_pro', 
                array(
    ...
    public function add_js_settings() {
        ...
        mn_register_script( 'ure-jquery-dual-listbox', plugins_url( '/pro/js/jquery.dualListBox-1.3.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-jquery-dual-listbox' );
...
?>
        ...
        echo $output . '&nbsp;&nbsp;&gt;&gt;&nbsp;<a href="' . mn_nonce_url("users.php?page=users-".URE_PLUGIN_FILE."&object=user&amp;user_id={$user->ID}", "ure_user_{$user->ID}") . '">' . esc_html__('Edit', 'user-role-editor') . '</a>';
        ?>
        			</td>
        		</tr>
        </table>		
