...
<form name="ure_posts_edit_access_form" id="ure_posts_edit_access_form" method="POST"
      action="<?php echo URE_ADMIN_URL . URE_PARENT .'?page=users-'. URE_PLUGIN_FILE;?>" >
<?php
        }
?>        
...
?>
                    <input type="radio" name="ure_posts_restriction_type" id="ure_posts_restriction_type0" value="0" <?php  echo $checked0;?> >
...
?>
            ...
            <tr>
               ...
               <?php esc_html_e('Own data only', 'user-role-editor'); ?>
        			...
        			<td>
               <input type="checkbox" name="ure_own_data_only" id="ure_own_data_only" <?php echo $checked3;?> value="1"/>
        			</td>
        		</tr>
        		<tr>
        			<th scope="row">               
