...
class URE_Posts_Edit_Access_Bulk_Action {
    ...
    public function add_css() {
        ...
        if (stripos($_SERVER['REQUEST_URI'], 'admin/edit.php') === false) {
            return;
        }
...
<?php
        ...
        mn_register_script( 'ure-bulk-edit-access', plugins_url( '/pro/js/ure-bulk-edit-access.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-bulk-edit-access' );      
        mn_localize_script( 'ure-bulk-edit-access', 'ure_bulk_edit_access_data', array(
