...
class URE_Widgets_Admin_Access {
    ...
    public function __construct() {
        ...
        $this->objects = new URE_Widgets_Admin();
...
<?php
    ...
    public function add_js() {
        mn_register_script( 'ure-widgets-admin-access', plugins_url( '/pro/js/widgets-admin-access.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-widgets-admin-access' );
        mn_localize_script( 'ure-widgets-admin-access', 'ure_data_widgets_access',
                array(
