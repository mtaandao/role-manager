...
class URE_WC_Bookings {
    ...
    public static function add_related_wc_bookings($posts) {
        global $pagenow, $mndb, $current_user;
        ...
        $query = "select ID, post_type from {$mndb->posts} where post_type='wc_booking'";
        ...
        foreach ($list as $post_id) {
            ...
            if ($products[$product_id]===$current_user->ID) {
