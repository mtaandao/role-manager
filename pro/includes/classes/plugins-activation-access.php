...
class URE_Plugins_Activation_Access {
    ...
    public function __construct() {
        ...
        $this->user_meta_key = $mndb->prefix . 'ure_allow_plugins_activation';        
   ...
   /**
    ...
    public function admin_load_js($hook_suffix) {
        ...
        if ($hook_suffix === 'user-edit.php') {
            ...
            mn_register_script('ure-user-profile-plugins', plugins_url('/pro/js/ure-pro-user-profile-plugins.js', URE_PLUGIN_FULL_PATH));
            mn_enqueue_script('ure-user-profile-plugins');
            mn_localize_script('ure-user-profile-plugins', 'ure_data_plugins', array(
