...
jQuery(function ($) {
        ...
        $('#ure_rename_role_dialog').dialog({
            ...
            'buttons': {
                'Rename Role': function () {
                    ...
                    $(this).dialog('close');
                    $.ure_postGo(ure_data.page_url,
                            {action: 'rename-role', user_role_id: role_id, user_role_name: role_name, ure_nonce: ure_data.mn_nonce}
                    );
                },
                Cancel: function () {
                    $(this).dialog('close');
        ...
        $('#ure_delete_role_dialog').dialog({
            ...
            buttons: {
                'Delete Role': function () {
                    ...
                    $(this).dialog('close');
                    $.ure_postGo(ure_data.page_url,
                            {action: 'delete-role', user_role_id: user_role_id, ure_nonce: ure_data.mn_nonce});
                },
                Cancel: function () {
                    $(this).dialog('close');
                }
        ...
        $('#ure_add_capability_dialog').dialog({
            ...
            'buttons': {
                'Add Capability': function () {
                    ...
                    $(this).dialog('close');
                    $.ure_postGo(ure_data.page_url,
                            {action: 'add-new-capability', capability_id: capability_id, ure_nonce: ure_data.mn_nonce});
                },
                Cancel: function () {
                    $(this).dialog('close');
                }
        ...
        $('#ure_delete_capability_dialog').dialog({
            ...
            buttons: {
                'Delete Capability': function () {
                    ...
                    $.ure_postGo(ure_data.page_url,
                            {action: 'delete-user-capability', user_capability_id: user_capability_id, ure_nonce: ure_data.mn_nonce});
                },
                Cancel: function () {
                    $(this).dialog('close');
                }
        ...
        $('#ure_default_role_dialog').dialog({
            ...
            buttons: {
                'Set New Default Role': function () {
                    ...
                    $.ure_postGo(ure_data.page_url,
                            {action: 'change-default-role', user_role_id: user_role_id, ure_nonce: ure_data.mn_nonce});
                },
                Cancel: function () {
                    $(this).dialog('close');
                }
    ...
    $('#ure_reset_roles_button').button({
        ...
        jQuery.ure_postGo(ure_data.page_url, {action: 'reset', ure_nonce: ure_data.mn_nonce});
    });
...
function ure_turn_caps_readable(user_id) {
    ...
    jQuery.ure_postGo(ure_data.page_url, {action: 'caps-readable', object: ure_object, user_id: user_id, ure_nonce: ure_data.mn_nonce});
...
function ure_turn_deprecated_caps(user_id) {
    ...
    jQuery.ure_postGo(ure_data.page_url, {action: 'show-deprecated-caps', object: ure_object, user_id: user_id, ure_nonce: ure_data.mn_nonce});
...
function ure_role_change(role_name) {
    ...
    jQuery.ure_postGo(ure_data.page_url, {action: 'role-change', object: 'role', user_role: role_name, ure_nonce: ure_data.mn_nonce});
...
function ure_hide_pro_banner() {
    ...
    jQuery.ure_postGo(ure_data.page_url, {action: 'hide-pro-banner', ure_nonce: ure_data.mn_nonce});
