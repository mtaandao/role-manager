...
<?php        
    ...
    public function add_js() {
        mn_register_script( 'ure-posts-view-access', plugins_url( '/pro/js/posts-view-access.js', URE_PLUGIN_FULL_PATH ) );
        mn_enqueue_script ( 'ure-posts-view-access' );
        mn_localize_script( 'ure-posts-view-access', 'ure_data_posts_view_access',
                array(
